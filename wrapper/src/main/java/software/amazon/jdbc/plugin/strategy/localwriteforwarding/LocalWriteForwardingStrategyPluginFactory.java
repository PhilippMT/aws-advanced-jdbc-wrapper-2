...
public class LocalWriteForwardingStrategyPluginFactory implements ConnectionPluginFactory {

  @Override
  public ConnectionPlugin getInstance(final FullServicesContainer servicesContainer, final Properties props) {
    return new LocalWriteForwardingStrategyPlugin(servicesContainer, props);
  }
}
